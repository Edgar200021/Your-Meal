...
const Button = ({
  ...
  const standart: string = `inline-block py-3 px-8 text-white bg-${bgColor} rounded-full hover:-translate-y-[6px] transition-transform duration-300 ease active:-translate-y-1 aria-[current=page]:scale-125 disabled:cursor-not-allowed `
